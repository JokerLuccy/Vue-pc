    ...
    <div class="content">
      ...
      >
        <span
          :class="{
            username: true,
            selected: userAddress.isDefault === '1',
          }"
      ...
      <div class="receiveInfo">
        ...
        <span>{{
          selectedAddress.userAddress
            ? selectedAddress.userAddress
            : userAddressList && userAddressList[0].userAddress
        }}</span>
        收货人：<span>{{
          selectedAddress.consignee
            ? selectedAddress.consignee
            : userAddressList && userAddressList[0].consignee
        }}</span>
        <span>{{
          selectedAddress.phoneNum
            ? selectedAddress.phoneNum
            : userAddressList && userAddressList[0].phoneNum
        }}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...mapState({
      detailArrayList: (state) => state.trade.tradeList.detailArrayList,
      tradeList: (state) => state.trade.tradeList,
      userAddressList: (state) => state.trade.tradeList.userAddressList,
    }),
  },
